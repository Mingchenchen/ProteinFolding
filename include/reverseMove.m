%{
Reverses the changes to the x- and y-coordinates of a residue subjected to a trial move.
...
%}
function [xvals, yvals] = reverseMove(xvals, yvals, trial_pos, x_moved, y_moved)
